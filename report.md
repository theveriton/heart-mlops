...
**Metrics**: `/metrics` endpoint with request count
**Future**: Prometheus/Grafana integration possible
...
- Build success: `screenshots/ci_success.png`
- Test results: `screenshots/test_results.png`
- Deployment: `screenshots/k8s_deploy.png`
